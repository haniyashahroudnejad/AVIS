...
class Car():
    ...
    data_arr = [speed_value, steering_value, image_mode,
                sensor_status, get_Speed, sensor_angle]
    ...
    def updateData(self):
        ...
        '''
        data = [self.speed_value, self.steering_value, self.image_mode,
                self.sensor_status, self.get_Speed, self.sensor_angle]
